...
const IndividualAccountForm = () => {
  ...
  const {
    ...
    resolver: zodResolver(createIndividualAccountSchema),
    mode: "onSubmit",
    defaultValues: {
      personalDetails: {
  ...
  //   const formData: CreateAccountSchemaType = getValues(); // Get all form values
  //   postData("create_new_account.php", formData);
  ...
  const onSubmit = (data: CreateAccountSchemaType) => {
    ...
    // Remove file objects from data before stringifying
    ...
    // formData.append("formData", JSON.stringify(dataWithoutFiles));
  ...
  return (
    <div className="w-full mt-14 bg-white">
      ...
      >
        ...
        {/* Add this for safe error debugging */}
                ...
                <div>
                  ...
                  <div className="lg:grid block items-center grid-cols-3 mt-2 gap-4">
                    <FormField
                      ...
                      name="personalDetails.account_type"
                      value={inputValue}
                      register={register}
                      type="hidden"
                    />
